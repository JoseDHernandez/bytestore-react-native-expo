...
const SummaryRow = ({
  ...
  <View style={styles.summaryRow}>
    <Text style={[styles.summaryLabel, bold && styles.summaryBold, large && styles.summaryLarge]}>
      {label}
    </Text>
    <Text style={[styles.summaryValue, bold && styles.summaryBold, large && styles.summaryLarge]}>
      {value}
    </Text>
  </View>
);
      ...
      {items.length > 0 && (
        <View style={styles.footer}>
          <View style={styles.summaryCard}>
            ...
            <SummaryRow
              label="Envío"
              value={shipping === 0 ? 'Gratis' : `$${shipping.toLocaleString('es-CO')}`}
            />
            {shipping > 0 && (
              <Text style={styles.shippingNote}>
                Compra ${(shippingThreshold - totalPrice).toLocaleString('es-CO')} más para envío gratis
              </Text>
            )}
